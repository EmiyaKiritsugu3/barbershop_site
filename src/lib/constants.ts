...
export const SERVICES_DATA: Service[] = [
  ...
  { id: '2', name: 'Barba Modelada', description: 'Design e modelagem da barba, com toalha quente e navalha para contornos precisos.', price: 'R$ 40', icon: Briefcase }, // Using Briefcase as a stand-in for a beard icon
...
export const TEAM_MEMBERS_DATA: TeamMember[] = [
  {
    id: '1',
    name: 'Arthur "O Mestre" Silva',
    role: 'Barbeiro Principal / Fundador',
    bio: 'Com mais de 15 anos de experiência, Arthur é especialista em cortes clássicos e técnicas tradicionais de barbearia, trazendo a arte da navalha para o século XXI.',
    imageUrl: 'https://placehold.co/300x300.png',
    dataAiHint: 'barber portrait',
    socialLinks: [{ platform: 'Instagram', url: '#', icon: Instagram }],
  },
  {
    id: '2',
    name: 'Beatriz "A Inovadora" Costa',
    role: 'Barbeira / Estilista',
    bio: 'Beatriz combina técnicas modernas com um olhar artístico, criando estilos contemporâneos e personalizados. Especialista em cortes degradê e design de barba.',
    imageUrl: 'https://placehold.co/300x300.png',
    dataAiHint: 'female barber',
    socialLinks: [{ platform: 'Instagram', url: '#', icon: Instagram }, { platform: 'LinkedIn', url: '#', icon: Linkedin }],
  },
  {
    id: '3',
    name: 'Carlos "O Detalhista" Pereira',
    role: 'Barbeiro',
    bio: 'Carlos é conhecido por sua precisão e atenção aos detalhes. Perfeccionista, garante que cada cliente saia com um corte e barba impecáveis.',
    imageUrl: 'https://placehold.co/300x300.png',
